...
description: Run the development server with hot reload, local mode, and public URLs by default.
---

Run your Agentuity project locally with automatic hot reload, type checking, and a public URL by default for sharing or webhook testing.
...
- Public URL tunneling by default (disable with `--no-public`)
