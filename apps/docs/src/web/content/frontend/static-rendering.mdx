...
Without `<!--app-html-->`, the build completes but the rendered HTML is not injected into the page. Put the placeholder inside the element your client app hydrates.
</Callout>
...
- [App Configuration](/get-started/app-configuration): Wire routes, CORS, and app-level settings
