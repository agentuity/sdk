...
// Mount API routes
const { default: router_0 } = await import('../api/hello/index.js');
app.route('/api/hello', router_0);
const { default: router_1 } = await import('../api/hello/route.js');
app.route('/api/hello', router_1);
