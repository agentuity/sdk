...
1. Create a bucket using the CLI or by signing in to the [Agentuity web app](https://app.agentuity.com/sign-in):
...
<Callout type="warning" title="Dev Mode Credentials">
...
<Callout type="info" title="Cloud Deployment">
