...
<Callout type="info" title="Port mapping enables networking">
...
When using the CLI, `--port` enables networking for you and returns the public URL directly in the create response. See [CLI Sandbox Commands](/reference/cli/sandbox#port-mapping) for details.
</Callout>
