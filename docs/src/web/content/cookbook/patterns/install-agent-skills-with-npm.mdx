...
If you prefer the Git catalog instead of npm dependencies, use the `skills` CLI:
...
See [Agent Skills CLI](/reference/cli/agent-skills) for more `skills` CLI options.
