...
- [Ack Message](/reference/api/queues#acknowledge-message): mark a message complete
- [Nack Message](/reference/api/queues#negative-acknowledge): return a message for retry
