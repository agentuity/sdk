...
For choosing between schema libraries and integration patterns, see [Schema Libraries](/reference/sdk-reference/schema). For how schemas attach to agents, see [Agents](/reference/sdk-reference/agents#agent-configuration).
