...
When you create a database with `agentuity cloud db create` from a project, the `DATABASE_URL` is added to your `.env` file. During deployment, credentials are injected automatically.
</Callout>
