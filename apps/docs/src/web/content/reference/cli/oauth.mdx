...
- [Configuration](/reference/cli/configuration): Manage environment variables and secrets from the CLI
- [Infrastructure Monitoring](/reference/cli/monitoring): Monitor machine health and resource usage in real time
