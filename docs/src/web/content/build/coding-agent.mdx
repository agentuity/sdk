---
title: The coding agent is a general-purpose agent
short_title: Coding Agent
description: Use the Coder SDK when the agent needs a repo, tools, session history, and live events.
---
...
| one isolated command or generated-code validation | [Sandbox `run()`](/services/sandbox/ephemeral-workflows) | the work has clear inputs, command output, and a short timeout |
...
Use [Coder](/services/coder) for session lifecycle, workspace, skills, replay, and participant details. Use [Managing Coder Sessions with the SDK](/cookbook/patterns/creating-coder-sessions-with-sdk) when you need complete session creation and polling examples.
