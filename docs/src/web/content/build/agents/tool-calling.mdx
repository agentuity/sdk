...
```bash
bun add ai@latest @ai-sdk/anthropic@latest @agentuity/keyvalue@next zod
```
...
```bash
bun add openai @agentuity/keyvalue@next zod
```
...
```bash
bun add @anthropic-ai/sdk @agentuity/keyvalue@next zod
```
