export const docsRedirects = {
	...
	patternsChatStreaming: '/build/agents/chat-and-streaming',
	buildBackgroundWork: '/build/apps-and-apis/background-work',
	buildChatAndStreaming: '/build/agents/chat-and-streaming',
	buildCodingAgent: '/build/agents/coding-agent',
	buildStateAndMemory: '/build/agents/state-and-memory',
	buildToolCalling: '/build/agents/tool-calling',
	frontend: '/frameworks',
	...
	cookbookChatSdk: '/build/agents/chat-and-streaming',
	cookbookProviderAgents: '/build/agents/tool-calling',
...
export const docRedirectRules = [
	...
	{
		paths: ['/build/background-work', '/build/background-work/'],
		target: docsRedirects.buildBackgroundWork,
	},
	{
		paths: ['/build/chat-and-streaming', '/build/chat-and-streaming/'],
		target: docsRedirects.buildChatAndStreaming,
	},
	{
		paths: [
			'/build/coding-agent',
		...
		target: docsRedirects.buildCodingAgent,
	},
	{
		paths: ['/build/state-and-memory', '/build/state-and-memory/'],
		target: docsRedirects.buildStateAndMemory,
	},
	{
		paths: ['/build/tool-calling', '/build/tool-calling/'],
		target: docsRedirects.buildToolCalling,
	},
