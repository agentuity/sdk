...
<Callout type="info" title="What Does the GitHub App Do?">
For an overview of how the Agentuity GitHub App automates deployments, including push-triggered deploys, PR preview environments, and GitHub status checks, see [Agentuity GitHub App](/reference/github-app).
</Callout>
