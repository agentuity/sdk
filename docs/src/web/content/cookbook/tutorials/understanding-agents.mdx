...
- Basic familiarity with [AI SDK Integration](/patterns/agents-as-a-pattern)
...
- [AI SDK Integration](/patterns/agents-as-a-pattern): More patterns for tool use and streaming
- [Calling Other Agents](/patterns/agents-as-a-pattern): Build multi-agent systems
