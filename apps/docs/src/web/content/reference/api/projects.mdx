...
Returns HTTP 409 if the project exists, HTTP 422 if it does not.
...
<ApiEndpoint method="GET" path="/cli/agent/{projectId}?identifier={agentId}" />
...
<ApiExample method="GET" path="/cli/agent/proj_abc123?identifier=agent_xyz" />
