			...
			<div className="content-wrapper">
				<div className="header">
					...
					{isAuthenticated && (
						<div className="auth-status">
							...
							<SignOutButton>
								<button className="auth-button signout" type="button">
									Sign Out
								</button>
							</SignOutButton>
						</div>
					...
					{!isAuthenticated && authLoading && (
						<div className="auth-status">
							<p className="user-info">Loading authentication...</p>
						</div>
					)}
					...
					{!isAuthenticated && !authLoading && (
						<div className="auth-status">
							<SignInButton>
								<button className="auth-button signin" type="button">
									Sign In to Continue
								</button>
							</SignInButton>
						</div>
				...
				{!isAuthenticated && (
					<div className="card">
						...
						<p style={{ color: '#a1a1aa', fontSize: '0.875rem', margin: '1rem 0 0 0' }}>
							Please sign in to try the Hello Agent and access protected features.
						</p>
					</div>
				)}
						...
						{[
							{
								...
								text: (
									<>
										This template uses Clerk for authentication. API calls automatically
										include your auth token. Check <code>src/api/index.ts</code> for
										protected routes.
									</>
								),
							},
