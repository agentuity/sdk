...
<Callout type="tip" title="Use receipts as the replay boundary">
...
- [Webhooks API Reference](/reference/api/webhooks): inspect REST fields, receipt shapes, and delivery details
