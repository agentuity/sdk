...
Connect your GitHub identity to Agentuity, then link repositories for automatic preview deployments.
...
agentuity git account remove --account inst_xyz --confirm
```
