...
description: Run the development server with hot reload, local mode, and optional public URLs.
---

Run your Agentuity project locally with automatic hot reload, type checking, and optional public URLs for sharing or webhook testing.
