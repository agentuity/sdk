...
| durable handoff with retries, status, and observability | [Queues](/services/queues) and the [Background Work](/build/apps-and-apis/background-work) pattern |
...
The full request, status, worker, and stream wiring lives in [Background Work](/build/apps-and-apis/background-work).
...
- [Background Work](/build/apps-and-apis/background-work): the durable request/status/worker/stream pattern
