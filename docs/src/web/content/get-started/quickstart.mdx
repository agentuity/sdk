...
| Service client | `npm install @agentuity/keyvalue@next` installs, and server code imports `KeyValueClient` | Keep the client in server-side code, not browser components |
