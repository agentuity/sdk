...
| --- | --- | --- |
| Create-supported Agentuity starter | You want Agentuity to scaffold one of the five built-in starters and example route. | `npm create agentuity@next -- --framework nextjs --services keyvalue` |
| New framework app | You already ran the framework's create command and want to add Agentuity next. | `npm install -D @agentuity/cli@next` |
| Existing app | The app already has routes, scripts, env conventions, and a working build. | `npm install -D @agentuity/cli@next` |
