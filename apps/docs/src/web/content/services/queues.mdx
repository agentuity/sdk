...
Use `@agentuity/queue` to access this service from any Node.js or Bun app without the full runtime. See [Standalone Packages](/reference/standalone-packages#message-queues) for install and usage.
</Callout>
