	...
	return {
		...
		plugins: await (async () => {
			...
			return [
				...
				browserEnvPlugin(),
				// Warn about legacy Agentuity-v1 `/public/` asset paths. The same
				// plugin runs in production via the wrapper config generated by
				// writeClientWrapperConfig in vite-builder.ts.
