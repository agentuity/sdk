...
The route below intentionally uses the OpenAI SDK to show provider SDK env wiring. For generic model calls, use `AIGatewayClient` or see [AI Gateway](/services/ai-gateway#choose-the-model-path).
