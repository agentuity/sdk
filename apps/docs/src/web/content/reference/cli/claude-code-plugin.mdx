...
| **agentuity-frontend** | Using Agentuity frontend packages | `@agentuity/react`, `@agentuity/auth`, `@agentuity/frontend`, `@agentuity/workbench` |
...
> `agentuity-frontend` activates with `@agentuity/react` hooks and `hc()` client guidance
