...
Build notification pipelines, auto-responders, and support inboxes by sending outbound emails and receiving inbound messages through addresses managed under your organization.
...
| Web App | [app.agentuity.dev](https://app.agentuity.dev) | Dashboard for addresses and history |
