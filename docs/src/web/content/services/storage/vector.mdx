...
<Callout type="info" title="Choose one embedding source per namespace">
...
- [Agents](/build/agents): use retrieved context in a model-backed workflow
- [Vector API Reference](/reference/api/vector): inspect REST fields and lower-level method details
