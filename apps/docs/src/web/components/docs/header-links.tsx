...
function HeaderLink({ href, children, label }: HeaderLinkProps) {
	return (
		<Button
			variant="ghost"
			size="sm"
...
export function HeaderLinks() {
	return (
		<div className="hidden md:flex items-center gap-1">
			...
			<HeaderLink href="https://x.com/agentuity" label="X (Twitter)">
				<XIcon className="size-4" />
			</HeaderLink>
			<HeaderLink href="https://github.com/agentuity" label="GitHub">
