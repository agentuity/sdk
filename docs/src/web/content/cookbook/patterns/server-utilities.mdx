...
If you want to centralize storage logic in your Agentuity project (for [Hono middleware](/frameworks/hono), sharing across multiple apps, or avoiding SDK key distribution), use [Hono routes](/frameworks/hono) instead.
