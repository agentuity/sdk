...
<Callout type="tip" title="Active keys are extended on read">
...
<Callout type="info" title="Use the managed service for full KV behavior">
Search, key listing, stats, and namespace operations require the managed KV service. Run `agentuity dev` with your project configured for end-to-end local development.
</Callout>
...
- [Key-Value API Reference](/reference/api/key-value): inspect REST fields and lower-level method details
