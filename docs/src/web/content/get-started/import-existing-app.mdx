...
| --- | --- | --- |
| Create-supported Agentuity starter | You want Agentuity to scaffold one of the five built-in starters and example route. | `bun create agentuity@beta --framework nextjs --services keyvalue` |
| New framework app | You already ran the framework's create command and want to add Agentuity next. | `bun add -d @agentuity/cli@beta` |
| Existing app | The app already has routes, scripts, env conventions, and a working build. | `bun add -d @agentuity/cli@beta` |
