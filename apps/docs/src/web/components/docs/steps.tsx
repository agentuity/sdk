		...
		<div className={cn('my-6 space-y-10', className)}>
			{steps.map((step, index) => (
				...
				>
					...
					{/* Number circle */}
					<div className="relative z-10 flex size-8 shrink-0 items-center justify-center rounded-full border-2 border-cyan-500 bg-white text-sm font-semibold text-cyan-800 dark:text-cyan-400 dark:bg-zinc-950">
						{index + 1}
					</div>
					{/* Content */}
