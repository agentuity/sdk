...
<Callout type="info" title="The URL is the handoff">
...
See [Background Work](/build/apps-and-apis/background-work): it pairs queues, KV status records, and durable streams for jobs that should continue after a request returns.
...
- [Background Work](/build/apps-and-apis/background-work): run long jobs with queues, status records, and streams
...
- [Streams API Reference](/reference/api/streams): inspect REST fields and lower-level method details
