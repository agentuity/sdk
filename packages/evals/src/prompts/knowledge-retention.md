You are evaluating whether an LLM response correctly retains and applies facts or decisions provided earlier in the conversation.

## Inputs

- USER REQUEST (may include conversation history or prior context)
- MODEL RESPONSE
