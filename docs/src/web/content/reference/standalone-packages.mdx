...
| Package | Install | Use |
|---------|---------|-----|
| [`@agentuity/keyvalue`](#key-value-storage) | `npm install @agentuity/keyvalue@next` | exact-key data, TTL-backed cache, preferences, counters |
| [`@agentuity/vector`](#vector-search) | `npm install @agentuity/vector@next` | documents, embeddings, semantic search, retrieval |
| [`@agentuity/storage`](#object-storage) | `npm install @agentuity/storage@next` | S3-compatible file storage under Bun or Node.js |
| [`@agentuity/stream`](#durable-streams) | `npm install @agentuity/stream@next` | durable, resumable streams and generated files |
| [`@agentuity/aigateway`](#ai-gateway) | `npm install @agentuity/aigateway@next` | model catalog lookup and routed model requests |
| [`@agentuity/queue`](#message-queues) | `npm install @agentuity/queue@next` | async handoff to worker or pub/sub queues |
| [`@agentuity/email`](#email) | `npm install @agentuity/email@next` | managed email addresses, outbound email, inbound records |
| [`@agentuity/schedule`](#schedules) | `npm install @agentuity/schedule@next` | cron schedules and delivery tracking |
| [`@agentuity/task`](#tasks) | `npm install @agentuity/task@next` | work items, comments, tags, attachments, activity |
| [`@agentuity/sandbox`](#sandbox) | `npm install @agentuity/sandbox@next` | isolated command execution and long-lived sandboxes |
| [`@agentuity/webhook`](#webhooks) | `npm install @agentuity/webhook@next` | managed webhook ingest URLs, destinations, receipts |
| [`@agentuity/coder`](#coder) | `npm install @agentuity/coder@next` | Coder sessions, workspaces, custom agents, replay data |
| [`@agentuity/db`](#database) | `npm install @agentuity/db@next` | trusted admin scripts against the database service API |
| [`@agentuity/hono`](#hono) | `npm install @agentuity/hono@next hono` | Hono middleware that injects common clients on `c.var.*` |
| [`@agentuity/telemetry`](#telemetry) | `npm install @agentuity/telemetry@next` | logger, tracer, and meter setup outside Hono |
...
```bash
npm install @agentuity/vector@next
```
...
```bash
npm install @agentuity/storage@next
```
...
```bash
npm install @agentuity/stream@next
```
...
```bash
npm install @agentuity/aigateway@next
```
...
```bash
npm install @agentuity/queue@next
```
...
```bash
npm install @agentuity/sandbox@next
```
...
```bash
npm install @agentuity/email@next
```
...
```bash
npm install @agentuity/webhook@next
```
...
```bash
npm install @agentuity/schedule@next
```
...
```bash
npm install @agentuity/task@next
```
...
```bash
npm install @agentuity/coder@next
```
