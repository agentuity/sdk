...
Use WebSockets when you need **bidirectional** communication. For **server-to-client only** streaming, use [SSE](/routes/sse). For **peer-to-peer** media, use [WebRTC](/routes/webrtc).
