...
Use `@agentuity/keyvalue` to access this service from any Node.js or Bun app without the full runtime. See [Standalone Packages](/reference/standalone-packages#key-value-storage) for install and usage.
</Callout>
