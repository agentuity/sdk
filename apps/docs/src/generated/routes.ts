...
import type databaseAgent from '../agent/database/agent.js';
import type docQAAgent from '../agent/doc_qa/index.js';
import type emailAgent from '../agent/email/agent.js';
...
/**
 * Input type for route: POST /api/database
 */
export type POSTApiDatabaseInput = InferInput<typeof databaseAgent['inputSchema']>;

/**
 * Output type for route: POST /api/database
 */
export type POSTApiDatabaseOutput = InferOutput<typeof databaseAgent['outputSchema']>;

/**
 * Input schema type for route: POST /api/database
 */
export type POSTApiDatabaseInputSchema = typeof databaseAgent extends { inputSchema?: infer I } ? I : never;

/**
 * Output schema type for route: POST /api/database
 */
export type POSTApiDatabaseOutputSchema = typeof databaseAgent extends { outputSchema?: infer O } ? O : never;
...
/**
 * Input type for route: POST /api/email
 */
export type POSTApiEmailInput = InferInput<typeof emailAgent['inputSchema']>;

/**
 * Output type for route: POST /api/email
 */
export type POSTApiEmailOutput = InferOutput<typeof emailAgent['outputSchema']>;

/**
 * Input schema type for route: POST /api/email
 */
export type POSTApiEmailInputSchema = typeof emailAgent extends { inputSchema?: infer I } ? I : never;

/**
 * Output schema type for route: POST /api/email
 */
export type POSTApiEmailOutputSchema = typeof emailAgent extends { outputSchema?: infer O } ? O : never;
...
declare module '@agentuity/frontend' {
	...
	'POST /api/database': {
				inputSchema: POSTApiDatabaseInputSchema;
				outputSchema: POSTApiDatabaseOutputSchema;
				stream: typeof databaseAgent extends { stream?: infer S } ? S : false;
				params: never;
			};
	'POST /api/doc-qa': {
	...
	'POST /api/email': {
				inputSchema: POSTApiEmailInputSchema;
				outputSchema: POSTApiEmailOutputSchema;
				stream: typeof emailAgent extends { stream?: infer S } ? S : false;
				params: never;
			};
	'GET /api/evals': {
				inputSchema: never;
	...
	export interface RPCRouteRegistry {
		...
		database: {
			 ...
			 */
			post: { input: POSTApiDatabaseInput; output: POSTApiDatabaseOutput; type: 'api'; params: never; paramsTuple: [] };
		};
		docQa: {
			/**
		...
		email: {
			 ...
			 */
			post: { input: POSTApiEmailInput; output: POSTApiEmailOutput; type: 'api'; params: never; paramsTuple: [] };
		};
		evals: {
			/**
			 * Route: GET /api/evals
