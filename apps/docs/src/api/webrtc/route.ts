/**
 * WebRTC Route - Peer-to-peer signaling for audio, video, and data channels.
 *
 * GET /          - Returns route info
 * WS /signal     - WebSocket signaling endpoint for WebRTC negotiation
 */
