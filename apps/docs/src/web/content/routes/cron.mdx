...
<Callout type="warning" title="Cron is being deprecated">
[Schedules](/services/schedules) are the newer way to run recurring jobs. Use them when you want platform-managed scheduling, delivery tracking, and retries.
</Callout>
