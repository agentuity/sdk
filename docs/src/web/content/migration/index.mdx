...
When the follow-up steps call the Agentuity CLI, use your package manager's exec wrapper if the CLI is only installed locally, for example `bunx agentuity ...` or `npx agentuity ...`.
...
| you are starting a new app | create a v3 app with `bun create agentuity@next` |
