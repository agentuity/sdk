...
Customize how your project is built by creating an `agentuity.config.ts` file in your project root. Add Vite plugins for frontend builds, define build-time constants, or bundle extra files into your deployment.
...
Configure the development Workbench UI. See [Testing with Workbench](/agents/workbench) for usage.
