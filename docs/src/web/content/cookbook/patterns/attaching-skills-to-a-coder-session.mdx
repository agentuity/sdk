...
System skills are platform-managed. Saved skills and skill buckets are the part your app owns. Save them to your library once, then attach them to new sessions with `savedSkillIds` or `skillBucketIds`, so you don't reship the definitions each time.
...
- system skills are platform-managed
