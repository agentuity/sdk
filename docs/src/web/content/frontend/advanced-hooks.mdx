...
Use this pattern when you need richer call telemetry, custom data channel flows, or room-specific UX beyond the basic examples on [WebRTC](/patterns/chat-and-streaming).
...
- [Chat and Streaming](/patterns/chat-and-streaming): server-side WebSocket and SSE patterns
