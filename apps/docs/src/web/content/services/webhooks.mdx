...
Use `@agentuity/webhook` to access this service from any Node.js or Bun app without the full runtime. See [Standalone Packages](/reference/standalone-packages#webhooks) for install and usage.
</Callout>
