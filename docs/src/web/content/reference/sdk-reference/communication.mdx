...
See [Agents](/build/agents) for model-backed workflows and [Background Work](/build/apps-and-apis/background-work) for moving slower work out of request handlers.
</Callout>

## Shared Function

```bash
npm install @agentuity/keyvalue@next zod
```
