...
Use `@agentuity/vector` to access this service from any Node.js or Bun app without the full runtime. See [Standalone Packages](/reference/standalone-packages#vector-search) for install and usage.
</Callout>
