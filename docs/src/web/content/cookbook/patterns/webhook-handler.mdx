...
```bash
npm install hono stripe @agentuity/queue@next @agentuity/keyvalue@next
```
...
- [Background Work](/build/apps-and-apis/background-work): wire request, status, worker, and stream routes around a queue
