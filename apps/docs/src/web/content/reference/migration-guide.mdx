...
**v2**: Import agents explicitly into `createApp()`. This keeps the registered agents visible in one place and ensures they are included for runtime registration, workbench metadata, and agent-to-agent calls:
