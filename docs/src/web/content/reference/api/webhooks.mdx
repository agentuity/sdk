...
<ResponseFields fields={[
  ...
  },
  {
    "name": "internal",
    "type": "boolean",
    "description": "Whether the webhook is system-managed.",
    "required": false
  }
]} />
...
Returns the created webhook with its ingest URL when available.
...
<ResponseFields fields={[
  ...
  },
  {
    "name": "url",
    "type": "string",
    "description": "Fully-qualified ingest URL for sending events to this webhook when returned by the service",
    "required": false
  },
  {
    "name": "internal",
