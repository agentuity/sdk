...
interface AgentContext<TConfig = unknown, TAppState = unknown> {
  ...
  task: TaskStorage;                  // Work item tracking with lifecycle management
