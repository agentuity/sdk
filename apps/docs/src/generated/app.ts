...
if (__userMounts) {
	...
	const { default: router_5 } = await import('../api/database/route.js');
	app.route('/api/database', router_5);
	const { default: router_6 } = await import('../api/doc-qa/route.js');
	app.route('/api/doc-qa', router_6);
	const { default: router_7 } = await import('../api/durable-stream/route.js');
	app.route('/api/durable-stream', router_7);
	const { default: router_8 } = await import('../api/email/route.js');
	app.route('/api/email', router_8);
	const { default: router_9 } = await import('../api/evals/route.js');
	app.route('/api/evals', router_9);
	const { default: router_10 } = await import('../api/hello/route.js');
	app.route('/api/hello', router_10);
	const { default: router_11 } = await import('../api/key-value/route.js');
	app.route('/api/key-value', router_11);
	const { default: router_12 } = await import('../api/model-arena/route.js');
	app.route('/api/model-arena', router_12);
	const { default: router_13 } = await import('../api/object-storage/route.js');
