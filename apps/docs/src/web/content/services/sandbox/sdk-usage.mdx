...
Use `@agentuity/sandbox` to access this service from any Node.js or Bun app without the full runtime. See [Standalone Packages](/reference/standalone-packages#sandbox) for install and usage.
</Callout>
