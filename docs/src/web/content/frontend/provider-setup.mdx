...
The typed client comes from your exported router type. If route inference looks wrong, check that your root router is exported as a single chained expression.
</Callout>
