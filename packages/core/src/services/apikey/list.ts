...
export const APIKeyListRequestSchema = z.object({
	orgId: z.string().optional().describe('Optional organization filter for listed keys'),
	projectId: z.string().optional().describe('Optional project filter for listed keys'),
});

export type APIKeyListRequest = z.infer<typeof APIKeyListRequestSchema>;
