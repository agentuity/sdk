...
| **Routes** | `src/api/` | HTTP endpoints and transport triggers |

Agents contain your core logic with schema validation and lifecycle hooks. Routes define how agents get invoked over HTTP, WebSocket, SSE, and other transports. This separation keeps concerns clear: agents don't know how they're called, and routes handle all transport.
