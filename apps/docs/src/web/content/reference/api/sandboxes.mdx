...
<ApiExample method="GET" path="/fs/sbx_abc123" />
...
<ApiExample method="POST" path="/fs/upload/sbx_abc123" />
...
<ApiExample method="PUT" path="/sandbox/snapshots/snp_abc123/upload" />
