...
Traces are also visible in the Agentuity App, showing the full span hierarchy with timing. See [CLI Reference](/reference/CLI) for more trace viewing options.
