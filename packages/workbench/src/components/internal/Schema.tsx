...
/**
 * Schema content without sidebar positioning - for use in external sidebars
 */
export function SchemaContent({ className, showHeader = true, onClose }: SchemaContentProps) {
...
/**
 * Full schema component with sidebar positioning - for standalone use
 */
export function Schema({ className }: SchemaProps) {
	...
	return (
		<>
			...
			>
				<SchemaContent onClose={schemaPanel.close} />
			</div>
		</>
	);
}
