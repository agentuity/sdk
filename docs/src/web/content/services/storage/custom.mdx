...
| use a different S3-compatible object store | pass explicit credentials to `@agentuity/storage` or a runtime-native S3 client |
...
- [Object Storage](/services/storage/object): store files and binary blobs with `@agentuity/storage`
- [API Reference](/reference/api): inspect generated REST details before matching a full service interface
