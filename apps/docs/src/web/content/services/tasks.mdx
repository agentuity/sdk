...
<Callout type="tip" title="Standalone Package Available">
Use `@agentuity/task` to access this service from any Node.js or Bun app without the full runtime. See [Standalone Packages](/reference/standalone-packages#tasks) for install and usage.
</Callout>
