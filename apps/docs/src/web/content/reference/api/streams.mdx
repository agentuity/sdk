...
<ApiEndpoint method="POST" path="/stream" host="pulse" />
...
<ApiEndpoint method="POST" path="/stream/{id}/info" host="pulse" />
...
<ApiExample method="POST" path="/stream/stream_abc123/info" body={{}} host="pulse" />
...
<ApiEndpoint method="GET" path="/stream/{id}" host="pulse" />
...
<ApiExample method="GET" path="/stream/stream_abc123" host="pulse" />
...
<ApiEndpoint method="POST" path="/stream/list" host="pulse" />
...
<ApiEndpoint method="DELETE" path="/stream/{id}" host="pulse" />
...
<ApiExample method="DELETE" path="/stream/stream_abc123" host="pulse" />
...
<ApiEndpoint method="POST" path="/stream/{id}/append" host="pulse" />
...
<ApiExample method="POST" path="/stream/stream_abc123/append" body="<binary data>" headers={{"Content-Type":"application/octet-stream"}} host="pulse" />
...
<ApiEndpoint method="POST" path="/stream/{id}/complete" host="pulse" />
...
<ApiExample method="POST" path="/stream/stream_abc123/complete" host="pulse" />
